...
<div class="relative overflow-hidden rounded-2xl bg-white border border-slate-200 h-[200px] flex items-center">
  ...
  <div class="relative z-10 px-8 max-w-xl">
    <h1 class="text-[27px] font-bold text-[#0a192f] mb-2 leading-tight">Dashboard Admin Area</h1>
    <p class="text-slate-500 text-[15px]">Kelola IDP dan data pegawai area {{ auth()->user()->unit_induk }}.</p>
  </div>
</div>
...
{{-- Row: Quick Action / Todo + Distribusi Pegawai per Business Area --}}
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
  ...
  <div class="bg-white border border-[#E9EDF3] rounded-2xl shadow-sm p-5">
    ...
    <div class="space-y-3">
      <a href="{{ route('admin-area.idp.penetapan') }}" class="flex items-center gap-3 p-3 rounded-xl border border-slate-100 hover:border-indigo-200 hover:bg-indigo-50/40 transition-colors group">
      ...
      <a href="{{ route('admin-area.coaching.pemantauan') }}" class="flex items-center gap-3 p-3 rounded-xl border border-slate-100 hover:border-indigo-200 hover:bg-indigo-50/40 transition-colors group">
  ...
  {{-- Distribusi Pegawai per Business Area --}}
  <div class="bg-white border border-[#E9EDF3] rounded-2xl shadow-sm p-5 lg:col-span-2">
    <div class="flex items-center justify-between mb-5">
      <div class="flex items-center gap-2">
        ...
        <h2 class="text-[15px] font-bold text-[#0a192f]">Distribusi Pegawai per Role</h2>
      </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
  ...
  <div class="bg-white border border-[#E9EDF3] rounded-2xl shadow-sm p-5">
    <div class="flex items-center justify-between mb-5">
      ...
      <a href="{{ route('admin-area.idp.pemantauan') }}" class="text-[12px] font-semibold text-indigo-600 hover:text-indigo-700 flex items-center gap-1">
        Lihat detail
